...
from cdnp.model.flow_matching.path.scheduler.scheduler import Scheduler
...
class ScheduleTransformedModel(ModelWrapper):
    ...
    .. code-block:: python
        ...
        import torch
        from cdnp.model.flow_matching.path.scheduler import CondOTScheduler, CosineScheduler, ScheduleTransformedModel
        from cdnp.model.flow_matching.solver import ODESolver
