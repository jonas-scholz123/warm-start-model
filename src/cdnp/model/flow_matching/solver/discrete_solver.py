...
from cdnp.model.flow_matching.path import MixtureDiscreteProbPath
from cdnp.model.flow_matching.solver.solver import Solver
from cdnp.model.flow_matching.utils import ModelWrapper, categorical
    ...
    def sample(
        ...
        **model_extras,
        ...
        .. code-block:: python
            ...
            from cdnp.model.flow_matching.solver import MixtureDiscreteEulerSolver
